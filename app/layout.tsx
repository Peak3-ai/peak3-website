...
export const metadata: Metadata = {
    ...
    description: "Turn busywork into autonomous growth. Peak3 designs AI agents & automations that slash costs and give you back your time.",
    openGraph: {
        ...
        images: [
            {
                url: "https://peak3.ai/images/logo.png",
                width: 1200,
                height: 630,
