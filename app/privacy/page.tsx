    ...
    return (
        <div className="min-h-screen bg-[#ffffff] text-[rgb(11,30,64)]">
            ...
            <div className="privacy-container max-w-7xl mx-auto px-4 py-20 sm:px-6 lg:px-8">
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                            &quot;Our&quot; in this Agreement) refers to Peak3 studio LLC, 44 Montgomery St, San Francisco, CA 94104,
                            USA.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to Peak 3, accessible from <a href="https://peak3.ai"
                            rel="external nofollow noopener" target="_blank">https://peak3.ai</a></p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>By visiting this page on our website: <a href="https://peak3.ai" rel="external nofollow noopener"
                        target="_blank">https://peak3.ai</a></li>
                </ul>
            </div>
            <Footer />
        </div>
